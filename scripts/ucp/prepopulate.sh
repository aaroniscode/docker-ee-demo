...
/vagrant/scripts/ucp/create_user.sh "april" "password" "April" 2
/vagrant/scripts/ucp/create_user.sh "bob" "password" "Bob" 2
/vagrant/scripts/ucp/create_user.sh "charlie" "password" "Charlie" 2
/vagrant/scripts/ucp/create_user.sh "victor" "password" "Victor" 1
/vagrant/scripts/ucp/create_user.sh "felicity" "password" "Felicity" 3
/vagrant/scripts/ucp/create_user.sh "frank" "password" "Frank" 3
...
/vagrant/scripts/ucp/add_user_to_team.sh $qa_id "victor"

echo "Adding (Full Control) Felicity to the Security team"
/vagrant/scripts/ucp/add_user_to_team.sh $sec_id "felicity"

echo "Adding (Full Control) Frank to the Operations team"
/vagrant/scripts/ucp/add_user_to_team.sh $ops_id "frank"
